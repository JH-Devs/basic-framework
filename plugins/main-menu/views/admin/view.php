<?php if (user_can('view_menu_page')): ?>
    <?php if (!empty($row)): ?>
        ...
        <label class="text-center  mb-2">
            ...
            <label class="text-center  mb-2">
            Mega Image: <br>
                    <img src="<?=get_image($row->mega_image)?>" class="img-thumbnail" style="width:100%;max-width:200px;height:200px;object-fit:cover;"/>
                </label>
        </div>
            ...
            <div class="mb-3 col-md-6">
                <div class="form-control"><b>Is Mega: </b><?=esc($row->is_mega) ? 'Yes' : 'No' ?></div>
            </div>
