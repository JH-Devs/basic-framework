...
<form method="post" enctype="multipart/form-data">
    ...
    <?php endif ?>
        ...
        <div class="mb-2 col-md-12">
            <label for="parent" class="form-label"><?= esc('Parent') ?></label>
            ...
            <?php if (!empty($errors['parent'])):?>
                <small class="text-danger px-2"><?= $errors['parent'] ?></small>
            <?php endif ?>
        </div>
        ...
        <div class="mb-2 col-md-6">
            <label for="is_mega" class="form-label"><?= esc('Is Mega') ?></label>
