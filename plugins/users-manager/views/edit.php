...
?>
        ...
        <div class="mb-3 col-md-6">
            ...
            <input value="<?= old_value('first_name', $row->first_name) ?>" type="text" class="form-control" name="first_name" >
        ...
        <div class="mb-3 col-md-6">
            ...
            <input value="<?=old_value('last_name', $row->last_name)?>" type="text" class="form-control" name="last_name" >
    ...
    <?php endif ?>
        ...
        <div class="mb-3 col-md-6">
            ...
            <select class="form-select" name="gender">
                ...
                <option <?= old_select('gender', 'male', $row->gender) ?> id="male" value="male"><?= esc('Male') ?></option>
                <option <?= old_select('gender', 'female', $row->gender) ?> id="female" value="female"><?= esc('Female') ?></option>
            </select>
        ...
        <div class="mb-3 col-md-6">
            ...
            <input value="<?=old_value('email', $row->email)?>" type="text" class="form-control" name="email" >
        ...
        <div class="mb-3 col-md-6">
            ...
            <small  id="leave_empty_to_keep_old_password" class="text-danger">(leave empty to keep old password)</small>
					...
					<?php if (!empty($roles)): $num = 0 ?>
						<?php foreach ($roles as $role): $num++ ?>
							<div class="form-check col-md-6">
								<input <?= in_array($role->id, $row->role_ids ?? []) ? ' checked ' : '' ?>
