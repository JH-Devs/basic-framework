...
if(!empty($row))
{
	...
	if($csrf && $files_ok && $footer->validate_update($postdata)) {
		if(user_can('edit_footer_page'))
		{
	...
	set_value('errors',array_merge($footer->errors,$req->upload_errors));
}else{
