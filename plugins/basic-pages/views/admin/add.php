...
<form onsubmit="page.submit(event)" method="post" enctype="multipart/form-data">
    ...
    <?=csrf()?>
        ...
        <h4 id="add_record">Add Website Page</h4>
        <div class="row">
        ...
        <div class="row">
            ...
            <select class="form-select" name="show_contact_form" id="show_contact_form">
                <option <?= old_select('show_contact_form', '0') ?> value="0"><?= esc('No') ?></option>
                <option <?= old_select('show_contact_form', '1') ?> value="1"><?= esc('Yes') ?></option>
            </select>
        </div>
