...
<?=csrf()?>
    ...
    <h4 id="add_record">Edit Website Page</h4>
    <div class="row">
    ...
    <div class="col-md-9">
        <div class="mb-3 col-md-12">
            ...
            <input value="<?= old_value('title', $row->title) ?>" type="text" class="form-control" name="title" id="title" >
        ...
        <div class="mb-3 col-md-12">
            ...
            <input value="<?= old_value('slug', $row->slug) ?>" type="text" class="form-control" name="slug" id="slug">
        ...
        <div class="mb-3 col-md-12">
            ...
            <input value="<?= old_value('keywords', $row->keywords) ?>" type="text" class="form-control" name="keywords" id="keywords">
    ...
    <div class="row">
        <div class="mb-3 col-md-4">
            ...
            <select name="display_featured_image" class="form-select">
                <option <?=old_select('display_featured_image','1',$row->display_featured_image)?> value="1">Yes</option>
                <option <?=old_select('display_featured_image','0',$row->display_featured_image)?> value="0">No</option>
            </select>
        </div>
                    
        <div class="mb-2 col-md-4">
            <label for="disabled" class="form-label">Public</label>
        ...
        <div class="mb-2 col-md-4">
            <label for="show_contact_form" class="form-label">Add contact form</label>
            <select class="form-select" name="show_contact_form" id="show_contact_form">
                <option <?= old_select('show_contact_form', '0', $row->show_contact_form) ?> value="0">No</option>
                <option <?= old_select('show_contact_form', '1', $row->show_contact_form) ?> value="1">Yes</option>
            </select>
        </div>
    ...
    <div class="mb-3 col-md-12">
        ...
        <textarea rows="10" name="content" id="content" class="summernote form-control"><?= old_value('content', $row->content) ?></textarea>
    ...
    <div class="mb-3 col-md-12 ">
            ...
            <?php 
			    ...
			    $cat_ids = $categories_map->get_category_ids($id);
			?>

				<?php if(!empty($categories)):$num = 0?>
					<?php foreach($categories as $category):$num++?>
						<div class="form-check col-md-6">
							<input name="category[]" class="form-check-input" type="checkbox" value="<?=$category->id?>" id="check<?=$num?>" <?=(in_array($category->id, $cat_ids)) ? ' checked ':''?>>
    ...
    <div class="mb-3 col-md-12">
        <label for="seo_title" class="form-label">Title (SEO)</label>
            <input name="seo_title" value="<?= old_value('seo_title', $row->seo_title) ?>" type="text" class="form-control" id="seo_title">
    ...
    <div class="mb-3 col-md-12">
        ...
        <textarea rows="3" name="seo_description" id="seo_description" class="form-control"><?= old_value('seo_description', $row->seo_description) ?></textarea>
