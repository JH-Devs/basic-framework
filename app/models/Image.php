        ...
        if($type == 'image/jpeg') {
            ...
            if (!empty($exif['Orientation'])) {
                switch ($exif['Orientation']) {
                    case 3 :
                        $angle = 180; //rotate left
                        break;

                    case 5 :
                        $angle = -90; // flip vertical + 90 rotate
                        break;

                    case 6 :
                        $angle = -90; // 90 rotate right
                        break;

                    case 7 :
                        $angle = -90; // horizontal flip + 90 rotate 
                        break;

                    case 8 :
                        $angle = 90; // 90rotate left
                        break;
